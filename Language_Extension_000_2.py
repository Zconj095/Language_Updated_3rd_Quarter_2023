class Language_Extension_000_2:
	...
	print(CREATE,NEW,SYSTEM,FRAMEWORK,THAT,CAN,ANALYZE,SYSTEM,INPUT)
	print(SET,CAPABILITIES,FOR,SYSTEM,MAINFRAME,TO,ACCEPT,MANY,VARIABLE,AND,CONSTANT,INPUTS)
	print(MAKE,SYSTEM,MAINFRAME,CAPABLE,OF,ACCEPTING,INPUT,FOR,SYSTEM,MAINFRAME)
	print(DEVELOP,FUNCTION,DEVELOPMENT,TOOL,FOR,SYSTEM,MAINFRAME,TO,MAKE,CUSTOM,FUNCTIONS)